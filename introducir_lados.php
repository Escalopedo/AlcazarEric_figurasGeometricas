...
<head>
    ...
    <script src="js/validacion.js" defer></script> <!-- Incluir el archivo JS -->
</head>
<body>
    ...
    <form id="formulario" action="resultados.php" method="post">
        ...
        <?php if ($figura == 'cuadrado') { ?>
            ...
            <div id="error-lado1" class="error-message"></div> <!-- Div para el mensaje de error -->
        <?php } ?>
        ...
        <?php if ($figura == 'rectangulo') { ?>
            ...
            <div id="error-lado2" class="error-message"></div> <!-- Div para el mensaje de error -->
        <?php } ?>
        ...
        <?php if ($figura == 'triangulo') { ?>
            ...
            <div id="error-lado3" class="error-message"></div> <!-- Div para el mensaje de error -->
        <?php } ?>
